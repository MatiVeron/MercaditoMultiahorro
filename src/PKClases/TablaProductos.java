...
public class TablaProductos {
 ...
 public void LlenarTabla(JTable jTableProductos ) {
       try{ 
            ...
            String[] titulos = {"Codigo","Descripcion","Marca","Familia","Precio","Cantidad","Categoria"};/*ArrayList con los header de la tabla*/
            
            String sql= "select productos.id_producto, productos.nombre_producto, productos.precio_producto,productos.cantidad,categorias.nombre_categoria,marcas.nombre_marca,familias.nombre_familia \n" +
            "from   productos\n" +
